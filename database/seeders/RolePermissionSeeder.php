...
class RolePermissionSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $assign('noc', $ids([
            ...
            'customer.view',
            'subscription.view',
            'olt.view', 'olt.create', 'olt.update', 'olt.activate', 'olt.maintenance', 'olt.retire',
            'onu.view', 'onu.create', 'onu.update', 'onu.activate', 'onu.offline', 'onu.suspend', 'onu.retire',
            'router.view', 'router.create', 'router.update', 'router.activate', 'router.maintenance', 'router.retire',
            'fat.view', 'fat.create', 'fat.update', 'fat.activate', 'fat.maintenance', 'fat.retire',
            'network.view', 'network.manage',
        ...
        $assign('supervisor', $ids([
            ...
            'customer.view',
            'subscription.view',
            'package.view', 'package.create', 'package.update', 'package.activate', 'package.deprecate', 'package.retire',
            'olt.view', 'olt.create', 'olt.update', 'olt.activate', 'olt.maintenance', 'olt.retire',
            'onu.view', 'onu.create', 'onu.update', 'onu.activate', 'onu.offline', 'onu.suspend', 'onu.retire',
            'router.view', 'router.create', 'router.update', 'router.activate', 'router.maintenance', 'router.retire',
            'fat.view', 'fat.create', 'fat.update', 'fat.activate', 'fat.maintenance', 'fat.retire',
