                                ...
                                <div class="form-group">
                                    ...
                                    <select id="cluster_id" name="cluster_id"
                                        ...
                                        @foreach ($clusters as $cluster)
                                            <option value="{{ $cluster->id }}" {{ (string) old('cluster_id', $customer->cluster_id) === (string) $cluster->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="service_area_id" name="service_area_id"
                                        ...
                                        @foreach ($serviceAreas as $serviceArea)
                                            <option value="{{ $serviceArea->id }}" {{ (string) old('service_area_id', $customer->service_area_id) === (string) $serviceArea->id ? 'selected' : '' }}>
